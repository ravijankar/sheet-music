...
<museScore version="4.60">
  <Style>
    ...
    <oddHeaderL>$:partName:</oddHeaderL>
    <oddHeaderC>$:workTitle: p. $N of $n</oddHeaderC>
    <oddHeaderR>$:bookNum:</oddHeaderR>
    ...
    <evenFooterR>$M</evenFooterR>
    <oddFooterL></oddFooterL>
    <oddFooterC></oddFooterC>
    <oddFooterR>$M</oddFooterR>
    ...
    <translatorPosition>center</translatorPosition>
    ...
    <glissandoPosition>center</glissandoPosition>
    ...
    <bendPosition>center</bendPosition>
    ...
    <user1FontSize>40</user1FontSize>
    ...
    <user1Align>right,top</user1Align>
    <user1Offset x="0" y="0"/>
    <user1OffsetType>1</user1OffsetType>
    <user1FrameType>1</user1FrameType>
    <user1FramePadding>0.3</user1FramePadding>
    <user1FrameWidth>0.4</user1FrameWidth>
    <user1FrameRound>30</user1FrameRound>
    <user1FrameFgColor r="0" g="0" b="0" a="255"/>
    <user1FrameBgColor r="255" g="255" b="255" a="0"/>
    <user1Position>right</user1Position>
    <user2Name></user2Name>
